...
public class ScrollBarWin11UI extends BasicScrollBarUI {
	/*
	 * Đây là định nghĩa của lớp ScrollBarWin11UI, được mở rộng từ BasicScrollBarUI.
	 * Lớp này thực hiện tùy chỉnh giao diện cho thanh cuộn.
	 */
	...
	/*
	 * Trong lớp này, bạn sử dụng một đối tượng Animator để thực hiện animation cho
	 * thanh cuộn. Các thuộc tính animate, show, hover, và press được sử dụng để
	...
	public void installUI(JComponent c) {
		...
		c.setForeground(new Color(222, 220, 220));
		initAnimator();
	}
	...
	/*
	 * Đây là hai phương thức để tạo các nút tăng và giảm giá trị trong thanh cuộn.
	 * Các nút này được tạo dưới dạng các đối tượng ScrollButton, được tùy chỉnh để
	 * hiển thị một hình dạng hợp với giao diện
	 */
	@Override
	...
	/*
	 * Hai phương thức này được sử dụng để vẽ nền và phần thanh cuộn. Phương thức
	 * paintTrack() vẽ nền của thanh cuộn, trong khi paintThumb() vẽ phần "nút"
	 * thanh cuộn, thể hiện việc cuộn.
	 */
	...
	/**
	 * 
	 * @author Nguyen Thi Thu Hong Đây là một lớp nội tại (inner class) đại diện cho
	 *         nút tăng và giảm giá trị. Mỗi nút là một đối tượng ScrollButton riêng
	 *         biệt. Lớp này tạo ra các hình dạng và hiệu ứng cho các nút, xử lý các
	 *         sự kiện chuột để biểu thị trạng thái khi chuột hover hoặc nhấn.
	 *
	 */
	private class ScrollButton extends JButton {

		private final int orientation;// lưu trữ hướng các nút
		private final boolean isIncrease;// biểu thị nút này tăng hhay giảm giá trị
		private final Shape arrow;// lưu trữ hình dangj của mũi tên trên nút
		private boolean mouseHover;// biểu thị xem chuôt có nằm trên nút hay không
		private boolean mousePress;// biểu thị xem chuột có nhấn vào nút hay không
